	 ...
	 */
		 ...
		 */
					...
					for (var row = 0; row < numMonths[0]; row++) {
						...
						for (var col = 0; col < numMonths[1]; col++) {
							...
							if (inst.settings.timePicker == true) {
								...
								// month
								// headers
								'<table><tr><td align="center">' + '<input type="text" style="width:20px;line-height:20px;height:20px;" value="" id="date_hour" maxlength="2"> &nbsp:' + '<input type="text" style="width:20px;line-height:20px;height:20px;" value="" id="date_minutes" maxlength="2"> &nbsp:' + '<input type="text" style="width:20px;line-height:20px;height:20px;" value="" id="date_seconds" maxlength="2"></td></tr></table></div>' + '<div id="timepicker-hour" class="timepicker-hour" style="z-index:92;display:none;">' + '<table class="datepicker_houre_table">' + '<tr><td><span>0</span></td><td><span>1</span></td><td><span>2</span></td>' + '<td><span>3</span></td><td><span>4</span></td><td><span>5</span></td></tr>' + '<tr><td><span>6</span></td><td><span>7</span></td><td><span>8</span></td>' + '<td><span>9</span></td><td><span>10</span></td><td><span>11</span></td></tr>' + '<tr><td><span>12</span></td><td><span>13</span></td><td><span>14</span></td>' + '<td><span>15</span></td><td><span>16</span></td><td><span>17</span></td></tr>' + '<tr><td><span>18</span></td><td><span>19</span></td><td><span>20</span></td>' + '<td><span>21</span></td><td><span>22</span></td><td><span>23</span></td></tr>' + '</table></div>' + '<div id="timepicker-minutes" class="timepicker-hour" style="z-index:92;display:none;">' + '<table class="datepicker_minute_table">' + '<tr><td><span>0</span></td><td><span>1</span></td><td><span>2</span></td>' + '<td><span>3</span></td><td><span>4</span></td><td><span>5</span></td>' + '<td><span>6</span></td><td><span>7</span></td><td><span>8</span></td>' + '<td><span>9</span></td><td><span>10</span></td><td><span>11</span></td></tr>' + '<tr><td><span>12</span></td><td><span>13</span></td><td><span>14</span></td>' + '<td><span>15</span></td><td><span>16</span></td><td><span>17</span></td>' + '<td><span>18</span></td><td><span>19</span></td><td><span>20</span></td>' + '<td><span>21</span></td><td><span>22</span></td><td><span>23</span></td></tr>' + '<tr><td><span>24</span></td><td><span>25</span></td><td><span>26</span></td>' + '<td><span>27</span></td><td><span>28</span></td><td><span>29</span></td>' + '<td><span>30</span></td><td><span>31</span></td><td><span>32</span></td>' + '<td><span>33</span></td><td><span>34</span></td><td><span>35</span></td></tr>' + '<tr><td><span>36</span></td><td><span>37</span></td><td><span>38</span></td>' + '<td><span>39</span></td><td><span>40</span></td><td><span>41</span></td>' + '<td><span>42</span></td><td><span>43</span></td><td><span>44</span></td>' + '<td><span>45</span></td><td><span>46</span></td><td><span>47</span></td></tr>' + '<tr><td><span>48</span></td><td><span>49</span></td><td><span>50</span></td>' + '<td><span>51</span></td><td><span>52</span></td><td><span>53</span></td>' + '<td><span>54</span></td><td><span>55</span></td><td><span>56</span></td>' + '<td><span>57</span></td><td><span>58</span></td><td><span>59</span></td></tr>' + '</table></div>' + '<div id="timepicker-seconds" class="timepicker-hour" style="z-index:92;display:none;">' + '<table class="datepicker_second_table">' + '<tr><td><span>0</span></td><td><span>1</span></td><td><span>2</span></td>' + '<td><span>3</span></td><td><span>4</span></td><td><span>5</span></td>' + '<td><span>6</span></td><td><span>7</span></td><td><span>8</span></td>' + '<td><span>9</span></td><td><span>10</span></td><td><span>11</span></td></tr>' + '<tr><td><span>12</span></td><td><span>13</span></td><td><span>14</span></td>' + '<td><span>15</span></td><td><span>16</span></td><td><span>17</span></td>' + '<td><span>18</span></td><td><span>19</span></td><td><span>20</span></td>' + '<td><span>21</span></td><td><span>22</span></td><td><span>23</span></td></tr>' + '<tr><td><span>24</span></td><td><span>25</span></td><td><span>26</span></td>' + '<td><span>27</span></td><td><span>28</span></td><td><span>29</span></td>' + '<td><span>30</span></td><td><span>31</span></td><td><span>32</span></td>' + '<td><span>33</span></td><td><span>34</span></td><td><span>35</span></td></tr>' + '<tr><td><span>36</span></td><td><span>37</span></td><td><span>38</span></td>' + '<td><span>39</span></td><td><span>40</span></td><td><span>41</span></td>' + '<td><span>42</span></td><td><span>43</span></td><td><span>44</span></td>' + '<td><span>45</span></td><td><span>46</span></td><td><span>47</span></td></tr>' + '<tr><td><span>48</span></td><td><span>49</span></td><td><span>50</span></td>' + '<td><span>51</span></td><td><span>52</span></td><td><span>53</span></td>' + '<td><span>54</span></td><td><span>55</span></td><td><span>56</span></td>' + '<td><span>57</span></td><td><span>58</span></td><td><span>59</span></td></tr>' + '</table></div>' + '<table class="ui-datepicker-calendar"><thead>' + '<tr>';
			...
			_showYearSelect: function(drawYear, event) {
				...
				var scrollHeight = (drawYear - 1949) * 15;
...
(function($){	
	...
	$.fn.initLinkPopup=function(){
		...
		$("u.employee,u.item,u.cust").each(function(){
			var link = $(this);
				link.hover(function() {
...
//	var $moreQueryCaseIconContainerHeight= $(".moreQueryCaseIconContainer").height();
	...
	for(var j=0;j<tagNum;j++){
		heightTr=heightTr+parseInt($(".queryTable ",queryTableContain).children().children().eq(j).height());
	};
	if(moreQueryCaseIconState!='open'){
		...
		$(".queryTable tr").css("display","table-row");
...
//各种按钮 事件
function mbuttonFunction()
{
	
//	<div class="Marrowbutton">
//	<div class="MbuttonBody">这是一个箭头按钮button</div>
//	</div>  
//
//	<div class="MBluebutton">
//	<div class="MBluebuttonBody">蓝色带框按钮＋div</div>
//	</div> 
//
//	<div class="MBluebutton">
//	<div class="MBluebuttonRightIConBody">蓝色带框按钮＋div</div>
//	</div> 
	/*第一套样式下的baseButton*/
	$MBaseButton=$(".baseButton");
	$MBaseButton.each(function(i){
		$(this).before("<div class=\"baseButtonHead\"></div>");
		$(this).after("<div class=\"baseButtonRoot\"></div>");
	});
	 /*箭头按钮*/
	 $MtopBackButtonBody=$(".topBackButtonBody");
	
	 
	 $MtopBackButtonBody.each(function(i)
   {  
		 
		 
		 $(this).before("<div class=\"topBackButtonHead\"></div>");
			
		 $(this).after("<div class=\"topBackButtonRoot\"></div>");
		
		
   });
	 
	 $MtopBackButtonBody.hover(
				function(){
			          
			           $(this).prev(".topBackButtonHead").css("background-image","url(\"/skin/skin2/button/button_head2.png\")");
			           $(this).css("background-image","url(\"/skin/skin2/button/button_body2.png\")");
			           $(this).next(".topBackButtonRoot").css("background-image","url(\"/skin/skin2/button/button_root2.png\")");
					},
				function(){
				          
				           $(this).prev(".topBackButtonHead").css("background-image","url(\"/skin/skin2/button/button_head.png\")");
				           $(this).css("background-image","url(\"/skin/skin2/button/button_body.png\")");
				           $(this).next(".topBackButtonRoot").css("background-image","url(\"/skin/skin2/button/button_root.png\")");
						}
			);
		
	 $MtopBackButtonBody.click(
			function(){
	           alert("click");
			}
	);
	 /*白色按钮*/
 $MSearchFunButtonBody=$(".MSearchFunButtonBody");
	
	 
      $MSearchFunButtonBody.each(function(i)
   {  
		 
		 
		 $(this).before("<div class=\"MSearchFunButtonHead\"></div>");
			
		 $(this).after("<div class=\"MSearchFunButtonRoot\"></div>");
		
		
   });
     $MSearchFunButtonBody.click(
  			function(){
  	           alert("click");
  			}
  	);
     /*黄色按钮*/
 $MDataConButtonBody=$(".MDataConButtonBody");
	
	 
	 $MDataConButtonBody.each(function(i)
   {  
		 
		 
		 $(this).before("<div class=\"MDataConButtonHead\"></div>");
			
		 $(this).after("<div class=\"MDataConButtonRoot\"></div>");
		
		
   });
	 
	 $MYdataConButtonody.hover(
				function(){
					
			              $(this).css("background-image","url(\"/skin/skin2/button/dataConButton_body2.png\")");	
			       
					},
				function(){

				           $(this).css("background-image","url(\"/skin/skin2/button/dataConButton_body.png\")");
				           
						}
			);
		
	 $MDataConButtonBody.click(
			function(){
	           alert("click");
			}
	);
	 ...
	 /*蓝色边框按钮*/
	 $MTopFunButtonBody=$(".MTopFunButtonBody");
	
	 
	 $MTopFunButtonBody.each(function(i)
   {  
		 
		 
		 $(this).before("<div class=\"MTopFunButtonHead\"></div>");
			
		 $(this).after("<div class=\"MTopFunButtonRoot\"></div>");
		
		
   });
	 
	 $MTopFunButtonBody.hover(
				function(){
					
			              $(this).css("background-image","url(\"/skin/skin2/button/topFunButton_body2.png\")");	
			       
					},
				function(){

				           $(this).css("background-image","url(\"/skin/skin2/button/topFunButton_body.png\")");
				           
						}
			);
		
	 $MTopFunButtonBody.click(
			function(){
	           alert("click");
			}
	);
   ...
   {  
		 ...
		 $(this).before("<div class=\"topFunButtonHead\"></div>");
			
		 $(this).after("<div class=\"topAssistButtonRoot\"></div>");
		
		
   });
	 
	 $MBluebuttonRightIConBody.hover(
				function(){
					
			              $(this).css("background-image","url(\"/skin/skin2/button/topFunButton_body2.png\")");		
			              $(this).next(".topAssistButtonRoot").css("background-image","url(\"/skin/skin2/button/rightButton_end2.png\")");
					},
				function(){

				           $(this).css("background-image","url(\"/skin/skin2/button/topFunButton_body.png\")");
				           $(this).next(".topAssistButtonRoot").css("background-image","url(\"/skin/skin2/button/rightButton_end.png\")");
				       	
						}
			);
		
	 $MBluebuttonRightIConBody.click(
			function(){
	           alert("click");
			}
	);
...
function checkMbuttonFunction()
{
	...
	/*箭头按钮*/
	 $MtopBackButton=$(".topBackButton");
	 $MtopBackButton.each(function(i)
   {  
		 var tagName = $(this).get(0).tagName;
		 var textValue="a";
	     var event = $(this).attr("onclick");
		 ...
		 if(event!=undefined || event !=null){
			 ...
			 arrowbuttonHtml="<span class='topBackButton'  onclick="+event+" id="+id+"><span class=\"topBackButtonHead\"></span><span class=\"topBackButtonBody\">"+textValue+"</span><span class=\"topBackButtonRoot\"></span></span>";
				
		 }
		 else {
			 arrowbuttonHtml="<span class='topBackButton' id="+id+"><span class=\"topBackButtonHead\"></span><span class=\"topBackButtonBody\">"+textValue+"</span><span class=\"topBackButtonRoot\"></span></span>";
    ...
    $currentMtopBackButton=$(".topBackButton");
	 $currentMtopBackButton.hover(
				function(){
					
					 $(this).children(".topBackButtonHead").attr("class","topBackButtonHeadHover");
					 $(this).children(".topBackButtonBody").attr("class","topBackButtonBodyHover");
					 $(this).children(".topBackButtonRoot").attr("class","topBackButtonRootHover");
//			           $(this).children(".MbuttonHead").css("background-image","url(\"/skin/skin1/button/button_head2.png\")");
//			           $(this).children(".MbuttonBody").css("background-image","url(\"/skin/skin1/button/button_body2.png\")");
//			           $(this).children(".MbuttonRoot").css("background-image","url(\"/skin/skin1/button/button_root2.png\")");
					},
				function(){
						 $(this).children(".topBackButtonHeadHover").attr("class","topBackButtonHead");
						 $(this).children(".topBackButtonBodyHover").attr("class","topBackButtonBody");
						 $(this).children(".topBackButtonRootHover").attr("class","topBackButtonRoot");  
//						$(this).children(".MbuttonHead").css("background-image","url(\"/skin/skin1/button/button_head.png\")");
//						$(this).children(".MbuttonBody").css("background-image","url(\"/skin/skin1/button/button_body.png\")");
//						$(this).children(".MbuttonRoot").css("background-image","url(\"/skin/skin1/button/button_root.png\")");
						}
			);
	 $currentMtopBackButton.live('mousedown',function(){
		 $(this).children(".topBackButtonHeadHover").attr("class","topBackButtonHeadClick");
		 $(this).children(".topBackButtonBodyHover").attr("class","topBackButtonBodyClick");
		 $(this).children(".topBackButtonRootHover").attr("class","topBackButtonRootClick");	 
		 $(this).children(".topBackButtonHead").attr("class","topBackButtonHeadClick");
		 $(this).children(".topBackButtonBody").attr("class","topBackButtonBodyClick");
		 $(this).children(".topBackButtonRoot").attr("class","topBackButtonRootClick");	 
	 });

	 $currentMtopBackButton.live('mouseup',function(){
		 $(this).children(".topBackButtonHeadClick").attr("class","topBackButtonHead");
		 $(this).children(".topBackButtonBodyClick").attr("class","topBackButtonBody");
		 $(this).children(".topBackButtonRootClick").attr("class","topBackButtonRoot");	 
//		 $(this).children(".topBackButtonHead").attr("class","topBackButtonHeadClick");
//		 $(this).children(".topBackButtonBody").attr("class","topBackButtonBodyClick");
//		 $(this).children(".topBackButtonRoot").attr("class","topBackButtonRootClick");	 
	 });
	 $currentMtopBackButton.live('mouseleave',function(){
		 $(this).children(".topBackButtonHeadClick").attr("class","topBackButtonHead");
		 $(this).children(".topBackButtonBodyClick").attr("class","topBackButtonBody");
		 $(this).children(".topBackButtonRootClick").attr("class","topBackButtonRoot");	 
//		 $(this).children(".topBackButtonHead").attr("class","topBackButtonHeadClick");
...
//	);
	 /*白色按钮*/
	/* 
	 $MSearchFunButtonBody=$(".searchFunButton");
	 ...
	 if($(this).css('display')!='none'){
		...
		if(event!=undefined || event !=null){
			 arrowbuttonHtml="<span class=\"searchFunButton\"  onclick="+event+" id="+id+"><span class=\"searchFunButtonHead\"></span><span class=\"searchFunButtonBody\">"+textValue+"</span><span class=\"searchFunButtonRoot\"></span></span>";
		}
		else{
			 arrowbuttonHtml="<span class=\"searchFunButton\" id="+id+"><span class=\"searchFunButtonHead\"></span><span class=\"searchFunButtonBody\">"+textValue+"</span><span class=\"searchFunButtonRoot\"></span></span>";
		}
		$(this).before(arrowbuttonHtml);
		$(this).remove();
	 ...
	 $currentSearchFunbutton=$(".searchFunButton");
	  
	 $currentSearchFunbutton.hover(
				function(){
					 $(this).children(".searchFunButtonHead").attr("class","searchFunButtonHeadHover");
					 $(this).children(".searchFunButtonBody").attr("class","searchFunButtonBodyHover");
					 $(this).children(".searchFunButtonRoot").attr("class","searchFunButtonRootHover");
					},
				function(){
						 $(this).children(".searchFunButtonHeadHover").attr("class","searchFunButtonHead");
						 $(this).children(".searchFunButtonBodyHover").attr("class","searchFunButtonBody");
						 $(this).children(".searchFunButtonRootHover").attr("class","searchFunButtonRoot");
	 ...
	 /*黄色按钮*/
	 /*
	 $MDataConButtonBody=$(".dataConButton");
   ...
   {  
	  if($(this).css('display')!='none'){  
		 ...
		 if(event!=undefined || event !=null){
			 ...
			 arrowbuttonHtml="<span class=\"dataConButton\" onclick="+event+" id="+id+"><span class=\"dataConButtonHead\"></span><span class=\"dataConButtonBody\">"+textValue+"</span><span class=\"dataConButtonRoot\"></span></span>";
				
		 }
		 else {
			 arrowbuttonHtml="<span class=\"dataConButton\" id="+id+"><span class=\"dataConButtonHead\"></span><span class=\"dataConButtonBody\">"+textValue+"</span><span class=\"dataConButtonRoot\"></span></span>";
	  ...
	  $currentYellowMarrowbutton=$(".dataConButton");
	  
	  $currentYellowMarrowbutton.hover(
				function(){
					 $(this).children(".dataConButtonHead").attr("class","dataConButtonHeadHover");
					 $(this).children(".dataConButtonBody").attr("class","dataConButtonBodyHover");
					 $(this).children(".dataConButtonRoot").attr("class","dataConButtonRootHover");
	
			       
					},
				function(){
						 $(this).children(".dataConButtonHeadHover").attr("class","dataConButtonHead");
						 $(this).children(".dataConButtonBodyHover").attr("class","dataConButtonBody");
						 $(this).children(".dataConButtonRootHover").attr("class","dataConButtonRoot");
				           
						}
			);
	  
	  $currentYellowMarrowbutton.live('mousedown',function(){
		     $(this).children(".dataConButtonHeadHover").attr("class","dataConButtonHeadClick");
			 $(this).children(".dataConButtonBodyHover").attr("class","dataConButtonBodyClick");
			 $(this).children(".dataConButtonRootHover").attr("class","dataConButtonRootClick");
			 
			 $(this).children(".dataConButtonHead").attr("class","dataConButtonHeadClick");
			 $(this).children(".dataConButtonBody").attr("class","dataConButtonBodyClick");
			 $(this).children(".dataConButtonRoot").attr("class","dataConButtonRootClick");
	  });
	  $currentYellowMarrowbutton.live('mouseup',function(){
		     $(this).children(".dataConButtonHeadClick").attr("class","dataConButtonHead");
			 $(this).children(".dataConButtonBodyClick").attr("class","dataConButtonBody");
			 $(this).children(".dataConButtonRootClick").attr("class","dataConButtonRoot");
	  });
	  $currentYellowMarrowbutton.live('mouseleave',function(){
		     $(this).children(".dataConButtonHeadClick").attr("class","dataConButtonHead");
			 $(this).children(".dataConButtonBodyClick").attr("class","dataConButtonBody");
			 $(this).children(".dataConButtonRootClick").attr("class","dataConButtonRoot");
	  });
	 ...
	 /*蓝色边框按钮*/
	 /*
	 $MTopFunButtonBody=$(".topFunButton");
   ...
   {   if($(this).css('display')!='none'){
		 ...
		 if(event!=undefined || event !=null){
			 ...
			 arrowbuttonHtml="<span class=\"topFunButton\" onclick="+event+"  id="+id+" ><span class=\"topFunButtonHead\"></span><span class=\"topFunButtonBody\">"+textValue+"</span><span class=\"topFunButtonRoot\"></span></span>";
				
		 }
		 else {
			 arrowbuttonHtml="<span  class=\"topFunButton\" id="+id+" ><span class=\"topFunButtonHead\"></span><span  class=\"topFunButtonBody\">"+textValue+"</span><span class=\"topFunButtonRoot\"></span></span>";
	  ...
	  $currentBlueMarrowbutton=$(".topFunButton");
	  
	  $currentBlueMarrowbutton.hover(
				function(){
					 $(this).children(".topFunButtonHead").attr("class","topFunButtonHeadHover");
					 $(this).children(".topFunButtonBody").attr("class","topFunButtonBodyHover");
					 $(this).children(".topFunButtonRoot").attr("class","topFunButtonRootHover");
//			               $(this).children(".MBluebuttonBody").css("background-image","url(\"/skin/skin1/button/blueButton_body2.png\")");	
			       
					},
				function(){
						 $(this).children(".topFunButtonHeadHover").attr("class","topFunButtonHead");
						 $(this).children(".topFunButtonBodyHover").attr("class","topFunButtonBody");
						 $(this).children(".topFunButtonRootHover").attr("class","topFunButtonRoot");
//						$(this).children(".MBluebuttonBody").css("background-image","url(\"/skin/skin1/button/blueButton_body.png\")");
				           
						}
			);
	  $currentBlueMarrowbutton.live('mousedown',function(){
		     $(this).children(".topFunButtonHeadHover").attr("class","topFunButtonHeadClick");
			 $(this).children(".topFunButtonBodyHover").attr("class","topFunButtonBodyClick");
			 $(this).children(".topFunButtonRootHover").attr("class","topFunButtonRootClick");  
			 
		     $(this).children(".topFunButtonHead").attr("class","topFunButtonHeadClick");
			 $(this).children(".topFunButtonBody").attr("class","topFunButtonBodyClick");
			 $(this).children(".topFunButtonRoot").attr("class","topFunButtonRootClick");  
	  });
	  $currentBlueMarrowbutton.live('mouseup',function(){
			     $(this).children(".topFunButtonHeadClick").attr("class","topFunButtonHead");
				 $(this).children(".topFunButtonBodyClick").attr("class","topFunButtonBody");
				 $(this).children(".topFunButtonRootClick").attr("class","topFunButtonRoot");      
	  });
	  $currentBlueMarrowbutton.live('mouseleave',function(){		 
			     $(this).children(".topFunButtonHeadClick").attr("class","topFunButtonHead");
				 $(this).children(".topFunButtonBodyClick").attr("class","topFunButtonBody");
				 $(this).children(".topFunButtonRootClick").attr("class","topFunButtonRoot");  		   
	  });
//	  $currentBlueMarrowbutton.click(
//			function(){
//	           alert("蓝色框 button click");
//			}
//	);
...
//	  $currentMBluebuttonRightIConBodyn.click(
//			function(){
//				 var event = $(this).attr("onclick");
//				 
//	           alert(event);
...
//		 $(this).children(".topOrderButtonHead").attr("class","topOrderButtonHeadClick");
//		 $(this).children(".topOrderButtonBody").attr("class","topOrderButtonBodyClick");
//		 $(this).children(".topOrderButtonRoot").attr("class","topOrderButtonRootClick");
		 });
	/* $(".topOrderButton:first").mouseleave(function(){
		 $(this).children(".rightFirstTopOrderButtonHeadClick").attr("class","rightFirstTopOrderButtonHead");
		 $(this).children(".topOrderButtonBodyClick").attr("class","topOrderButtonBody");
		 $(this).children(".topOrderButtonRootClick").attr("class","topOrderButtonRoot");
		 });
	 $(".topOrderButton:not(:first)").mouseleave(function(){
		 $(this).children(".topOrderButtonHeadClick").attr("class","topOrderButtonHead");
		 $(this).children(".topOrderButtonBodyClick").attr("class","topOrderButtonBody");
		 $(this).children(".topOrderButtonRootClick").attr("class","topOrderButtonRoot");
		 });*/
...
var obj=new Image();
obj.src="/skin/skin2/loading/buttonLoading.gif";
//点击按钮正在加载中
		 ...
		 if(isUnfold=="yes")
			{
			 ...
			 $(this).parent().next(".foldContent").css("visibility","visible");            //让内容可见
		...
		else
			{
			 ...
			 $(this).parent().next(".foldContent").css("visibility","hidden");              //隐藏内容
...
//创建隐藏域记录title
function createHiddenInputForTitle(){
...
//	$.fn.initLoading();
	...
	// mbuttonFunction();
	 unfold();
     checkMbuttonFunction();
	$.fn.jNice();
	$.fn.initLinkPopup();
	createHiddenInputForTitle();
//	$.fn.detachLoading();
	//判断是否有分享微博的隐藏域
    if(config.sns==1){
	...
	detailJsp();
	try{
	var buttonRightContainerObj = $(".buttonRightContainer");
	var buttonRightContainerTop=buttonRightContainerObj.offset().top;
